...
CREATE TABLE ØvelseITReningsøkt (
    TreningsøktID INTEGER NOT NULL,
    ØvelseID INTEGER NOT NULL,
	Kilo FLOAT(24) NOT NULL,
    AntallSett INTEGER NOT NULL,
    AntallReps INTEGER NOT NULL,
    CONSTRAINT ØvelseITReningsøkt_PK PRIMARY KEY (TreningsøktID , ØvelseID),
    CONSTRAINT ØvelseITReningsøkt_FK1 FOREIGN KEY (TreningsøktID)
